...
function get_and_validate_department(args) {
  ...
  let
    ...
    notify_leave_start_reminder = validator.toBoolean(
      req.body[no_suffix ? 'notify_leave_start_reminder' : 'notify_leave_start_reminder__'+index]
    ),
    ...
    work_calendar_id = validator.trim(
      req.body[no_suffix ? 'work_calendar_id' : 'work_calendar_id__'+index] || ''
    );
  ...
  if (work_calendar_id && !_.contains(
  ...
  return {
    ...
    notify_leave_start_reminder : notify_leave_start_reminder,
    notify_leave_start_reminder_to_employee : notify_leave_start_reminder_to_employee,
    WorkCalendarId          : work_calendar_id || null,
    name                    : name,
  };
}
