 ...
 *  - flash_warning : saves the warning message(s) into the "flash".
    ...
    req.install_flash_messages = function(){
        ...
        req.session.keep_old = function(){
            if (res.locals.flash) {
                ...
                if (res.locals.flash.warnings) this.flash_warning( res.locals.flash.warnings );
            }
        };
    };
