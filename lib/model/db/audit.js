...
module.exports = function(sequelize, DataTypes){
  ...
  const Audit = sequelize.define("Audit", {
    ...
    // ВАЖНО: без underscored. В sequelize 5 underscored:true переводит все
    // атрибуты в snake_case (entityType -> entity_type), но таблица создана
    // с camelCase-колонками. timestamps/FK здесь заданы явно.
