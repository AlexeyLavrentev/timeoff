...
// sequelize 5 отключил строковые операторы ($or, $gt, ...) по умолчанию.
// Временно (фаза А) включаем их через operatorsAliases, чтобы не менять
// ~55 мест в коде. Конвертация в Op.* — отдельная фаза Б (для v6).
var Op = Sequelize.Op;
