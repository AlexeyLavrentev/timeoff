...
### Демо-данные для знакомства

Чтобы сразу увидеть заполненный календарь, а не пустой экран:

```bash
npm run seed-demo
```

Команда создаст демо-компанию с 4 отделами, 12 сотрудниками и набором
утверждённых и ожидающих согласования отпусков. Логин и одноразовый пароль
